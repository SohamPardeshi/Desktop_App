...
public class DesktopView extends FrameView {
        ...
        int column = 0;
	/*
	*	@return the next id number for participants
	*/
    ...
    /*
	*	@return the next id number for workshops
	*/
	...
	/*
	*	@return the next id for conference
	*/
    ...
    /*
	*	Creates any necessary text files if they do not exist
	*/
	public static void createNecessaryFiles() throws IOException{
		File path = new File(".\\DAP_Files");

		File confFile = new File(".\\DAP_Files\\CONFERENCES.txt");
		File partFile = new File(".\\DAP_Files\\PARTICIPANTS.txt");
		File typeFile = new File(".\\DAP_Files\\TYPE.txt");
		File workFile = new File(".\\DAP_Files\\WORKSHOP.txt");
		File regFile = new File(".\\DAP_Files\\WKSHP_REGISTRATION.txt");
	...
	*/
    ...
    public DesktopView(SingleFrameApplication app) {
        ...
        /*
		*	Adds an actionListener to the register button signing up users for workshops
		*/
	   ...
	   /*
		*	Starts the participant "adding" phase
		*/
       participantAdd.addActionListener(new ActionListener() {
        ...
        /*
		*	Depending on usage, ether creates new user, or edits user by changing text files
		*/
	   participantSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(participantRemove.isEnabled() == false && participantEdit.getText().equals("Cancel")){
                    if(!participantFirstBox.getText().equals("")
                         && !participantLastBox.getText().equals("")
                         && !participantIDBox.getText().equals("")
                         && !participantChapterBox.getText().equals(""))
                    {
       ...
       participantScrollPane.setVisible(true);
        /*
		*	Starts the participant "edit" phase OR turns into a cancel button, prematurely ending phase
		*/
	   participantEdit.addActionListener(new ActionListener() {
        ...
        /*
		*	Pop-up Box asking user if they would like to delete certain person
		*/
	   participantRemove.addActionListener(new ActionListener() {
		...
		/*
		*	Creates a mouse listener for the table filling out form data on click
		*/
       ...
       conferenceAdd.addActionListener(new ActionListener() {
		...
		/*
		*	Pop-Up asking user if they want to delete conference, then deletes based on answer
		*/
       conferenceRemove.addActionListener(new ActionListener() {
		...
		/*
		*	Starts Editing phase or acts as cancel button
		*/
       conferenceEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(conferenceEdit.getText().equals("Cancel")){
                   ...
                   conferenceSDay.setSelectedIndex(Integer.parseInt(sDate.substring(sDate.indexOf("-") + 1, sDate.lastIndexOf("-"))));
                   conferenceSMonth.setSelectedIndex(Integer.parseInt(sDate.substring(0, sDate.indexOf("-"))));
                   conferenceSYear.setSelectedItem(sDate.substring(sDate.lastIndexOf("-")+1));

                   conferenceEDay.setSelectedIndex(Integer.parseInt(eDate.substring(eDate.indexOf("-") + 1, eDate.lastIndexOf("-"))));
                   conferenceEMonth.setSelectedIndex(Integer.parseInt(eDate.substring(0, eDate.indexOf("-"))));
                   conferenceEYear.setSelectedItem(eDate.substring(eDate.lastIndexOf("-")+1));
                   ...
                   String startDate = (String) conferenceTable.getModel().getValueAt(row, 2);
                   String endDateDate = (String) conferenceTable.getModel().getValueAt(row, 3);

                   String sDay = startDate.substring(4,6);
                   String sMonth = startDate.substring(0,2);
                   String sYear = startDate.substring(7,11);                 
		...
		/*
		*	Depending on "phase", either saves new user or edits old user
		*/
            ...
            public void actionPerformed(ActionEvent e) {
                if(conferenceRemove.isEnabled() == false && conferenceEdit.getText().equals("Cancel")){
                        ...
                        try {
                          ...
                          writer.writeConferences((String) conferenceTable.getValueAt(row, 0), conferenceCity.getText() + ", " + conferenceState.getText(), conferenceSMonth.getSelectedIndex() + "-" + conferenceSDay.getSelectedIndex() + "-" + (String)conferenceSYear.getSelectedItem(),   (String)conferenceEMonth.getSelectedItem() + "-" + conferenceEDay.getSelectedIndex() + "-" + (String)conferenceEYear.getSelectedItem() );
                          conferenceReader.removeLine(conferenceReader.getLineOfID((String)conferenceTable.getValueAt(row, 0)));
                        } catch (IOException ex) {
                            Logger.getLogger(DesktopView.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        Object[] newRow = {(String) conferenceTable.getValueAt(row, 0) , conferenceCity.getText() + ", " + conferenceState.getText(), conferenceSMonth.getSelectedIndex() + "-" + conferenceSDay.getSelectedIndex() + "-" + (String)conferenceSYear.getSelectedItem(),   (String)conferenceEMonth.getSelectedItem() + "-" + conferenceEDay.getSelectedIndex() + "-" + (String)conferenceEYear.getSelectedItem()};
                        conferenceTableModel.removeRow(row);
	   ...
	   /*
	   *	Creates a mouseListener to fill out form data on mouse click
	   */
       ...
       /*
	   *	Starts "add" phase for workshops
	   */
	   ...
	   /*
	   *	Prompts the user asking if they want to remove  workshop, acting on their answer
	   */
       workshopRemove.addActionListener(new ActionListener() {
		...
		/*
	   *	Starts edit "phase" for workshops
	   */
	  ...
	  /*
	   *	Depending on use allows for either saving new workshop or editing old workshop
	   */
       ...
       /*
	   *	Allows for searching participantTable; A blank string resets	
	   */
       participantSearchButton.addActionListener(new ActionListener() {
		...
		/*
	   *	Allows for searching conferenceTable; A blank string resets	
	   */
       conferenceSearchButton.addActionListener(new ActionListener() {
		...
		/*
	   *	Allows for searching workshopTable; A blank string resets	
	   */
	   ...
	   */
       ...
       final Comparator<Object> yesChapter = new Comparator<Object>() {
			...
			public int compare(Object o1, Object o2) {
				...
				String leftType = (String)left[3];
                                String leftLast = (String)left[2];
                                System.out.println("Taco: " + left.length);
                                Integer leftChapter = (Integer)left[5];

                               
                                String rightType = (String)right[3];
                                String rightLast= (String)right[2];
                                Integer rightChapter = (Integer)right[5];
    ...
    private void initComponents() {
        ...
        workshopRemove.setFont(resourceMap.getFont("conferenceAdd3.font")); // NOI18N
