...
public class WorkshopReader {
	...
	public static String[] getLine(int numLine) throws FileNotFoundException{
		reader = new Scanner(new BufferedReader(new FileReader(".\\DAP_Files\\WORKSHOPS.txt")));
	...
	public Object[][] getWorkshopData() throws FileNotFoundException {
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter(".\\DAP_Files\\WORKSHOPS.txt"));
